<!--
  Abhishek Barali — GitHub profile README
  Paste into the README.md of the repo named "AbhishekBarali".
  Palette + type from kaiki.dev: deep-space monochrome,
  restrained cold blue (#7fa8d8), Space Grotesk / Space Mono.
-->

<div align="center">

<img src="https://readme-typing-svg.demolab.com?font=Space+Grotesk&weight=600&size=44&duration=1&pause=99999999&color=EEF3FB&center=true&vCenter=true&width=820&height=80&letterSpacing=10px&lines=ABHISHEK+BARALI" alt="Abhishek Barali" />

<img src="https://readme-typing-svg.demolab.com?font=Space+Mono&weight=400&size=15&duration=3600&pause=1100&color=8D9AB4&center=true&vCenter=true&width=680&height=30&lines=building+agentic+AI+-+agents+that+plan%2C+use+tools%2C+and+act;multi-agent+orchestration+%C2%B7+RAG+%C2%B7+LLM-powered+products" alt="" />
...
Hey 🖐️, I'm Abhishek. Computer Science student . I build **agentic AI**, autonomous systems that plan, call tools, and act toward a goal with minimal hand-holding, along with the orchestration, retrieval, and guardrails that keep them reliable in production.
...
- **Multi-agent systems** · orchestrating specialized agents and tools, not single-shot prompts
- **Reliability** · evals, guardrails, and graceful recovery so agents hold up in production
- **Context engineering** · giving models the right context over endless prompt-tweaking
- **Shipping** · LLM products from prototype to something people actually use
...
![Python](https://img.shields.io/badge/Python-0a0e18?style=flat-square&logo=python&logoColor=3776AB) ![TypeScript](https://img.shields.io/badge/TypeScript-0a0e18?style=flat-square&logo=typescript&logoColor=3178C6) ![Rust](https://img.shields.io/badge/Rust-0a0e18?style=flat-square&logo=rust&logoColor=E43717) ![JavaScript](https://img.shields.io/badge/JavaScript-0a0e18?style=flat-square&logo=javascript&logoColor=F7DF1E)

![PyTorch](https://img.shields.io/badge/PyTorch-0a0e18?style=flat-square&logo=pytorch&logoColor=EE4C2C) ![Hugging Face](https://img.shields.io/badge/Hugging%20Face-0a0e18?style=flat-square&logo=huggingface&logoColor=FFD21E) ![OpenAI](https://img.shields.io/badge/OpenAI-0a0e18?style=flat-square&logo=openai&logoColor=FFFFFF)

![React](https://img.shields.io/badge/React-0a0e18?style=flat-square&logo=react&logoColor=61DAFB) ![Next.js](https://img.shields.io/badge/Next.js-0a0e18?style=flat-square&logo=nextdotjs&logoColor=FFFFFF) ![FastAPI](https://img.shields.io/badge/FastAPI-0a0e18?style=flat-square&logo=fastapi&logoColor=009688) ![Tailwind](https://img.shields.io/badge/Tailwind-0a0e18?style=flat-square&logo=tailwindcss&logoColor=06B6D4)
